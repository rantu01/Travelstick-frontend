    ...
    <>
      ...
      <div className=" rounded dashboardInput bg-white">
          <div className="flex justify-between px-8 pt-8 items-center">
            <h1 className="heading-3 text-[#05073C]">{i18n.t("Blog Tags")}</h1>
            <BackButton />
          </div>
          <Table
            columns={columns}
          ...
          <Modal
            ...
            title={isEdit ?
              <h2 className="heading-4 text-[#05073C]"> {i18n.t('Edit Blog Tag')} </h2> : <h2 className="heading-4 text-[#05073C]">{i18n.t('Add New Blog Tag')}</h2>}
            footer={null}
            destroyOnClose={true}
          >
