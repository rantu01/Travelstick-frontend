...
const VisaType = () => {
  ...
  const [data, getData, { loading }] = useFetch(getAllVisaType);
    ...
    <>
      ...
      <div className=" rounded dashboardInput bg-white">
          <div className="flex justify-between px-8 pt-8 items-center">
            <h1 className="heading-3 text-[#05073C]">{i18n.t("Visa Types")}</h1>
            <BackButton />
          </div>
            ...
            title={
              isEdit ? (
                <h2 className="heading-4 text-[#05073C]">
                  {" "}
                  {i18n.t("Edit Visa Type")}{" "}
                </h2>
              ) : (
                <h2 className="heading-4 text-[#05073C]">
                  {i18n.t("Add New Visa Type")}
                </h2>
              )
            }
            footer={null}
          ...
          >
            ...
            <Form
              ...
              onFinish={(values) => {
                ...
                return useAction(
                  isEdit ? updateVisaType : createVisaType,
                  {
                    body: {
                      ...formattedData,
                      _id: values?._id,
