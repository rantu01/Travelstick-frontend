  ...
  return (
    <AnimatedContent direction="horizontal" reverse={false}>
      <Link href={`/package/${data?._id}`}>
        <div className="group relative w-full h-[250px] md:h-[250px] rounded-[20px] overflow-hidden cursor-pointer shadow-md transition-all duration-300">
          ...
          {/* Red Overlay Gradient (Image er moto bottom overlay) */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#7f1b3d] via-[#7f1b3d]/40 to-transparent opacity-80 z-10"></div>
          
          {/* Hover Maroon Tint */}
          <div className="absolute inset-0 bg-[#7f1b3d]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-15"></div>
