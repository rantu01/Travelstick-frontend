...
const HeroFilters = () => {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 mt-10 font-sans">
      {/* Tabs - Mobile scrollable version */}
      ...
      <div className="bg-white p-4 md:p-6 rounded-2xl shadow-2xl relative z-10 border border-gray-100">
        {tab === "flight" && (
