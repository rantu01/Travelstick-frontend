...
const Filters = ({ getData }) => {
  ...
  useEffect(() => {
    ...
    const activitiesBlock = packageSideData?.find(
      (item) => item.key === "activities"
    );

    if (activitiesBlock) {
      setActivities(activitiesBlock.values || []);
    }
  ...
  return (
    <div>
      <div className="border border-[#E8EAE8] rounded-[10px] lg:rounded-[20px] xl:p-6 lg:p-5 md:p-4 p-3">
        <h4 className="description-2 text-[#05073C] !font-bold border-b border-[#E8EAE8] pb-2">
          {i18n.t("Destination")}
        </h4>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <label
                      ...
                      className="w-4 h-4 inline-block rounded-full border-[1px] border-gray-300 cursor-pointer peer-checked:bg-primary peer-checked:border-primary"
                    ></label>
