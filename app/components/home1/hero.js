      ...
      <div className="w-full h-full bg-black bg-opacity-[50%]">
        <div className="travel-container flex flex-col  justify-center items-center pt-[172px]">
          <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
            ...
            >
              {hero?.heading?.[langCode] || "Welcome to Travel"}
            </button>
            ...
            <Link
              href="/package"
              className="leading-[26px] relative z-50 animate-bounceLeftRight lg:mt-[59px] mt-[30px] font-lato font-medium sm:text-[18px] text-sm sm:px-[55px] px-6 sm:py-[18px] py-2 hover:bg-[#EB662B] transition-all duration-300  bg-primary text-white rounded-full"
            >
