      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="w-8 h-8 rounded-full border border-[#1a4fa0] text-[#1a4fa0] flex items-center justify-center hover:bg-blue-50"
            >
              <FaPlus size={10} />
            </button>
          </div>
        ...
        <div className="mt-2">
          <div className="flex items-center justify-between">
            ...
            <div
              ...
              className={`w-11 h-6 flex items-center rounded-full p-1 cursor-pointer transition-colors ${withPets ? 'bg-[#1a4fa0]' : 'bg-gray-300'}`}
            >
          ...
          <p className="text-[10px] text-gray-400 mt-2 leading-tight">
            Assistance animals are not classified as pets. <span className="text-[#1a4fa0] cursor-pointer hover:underline">Learn more.</span>
          </p>
        </div>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <button
            ...
            className="bg-[#1a4fa0] text-white px-6 py-2 rounded-full font-bold flex items-center gap-2 hover:bg-[#123a7a] transition-all active:scale-95 shadow-sm"
          >
            Apply
            <span className="flex items-center justify-center w-4 h-4 rounded-full border border-white text-[10px]">✓</span>
          </button>
        </div>
      </div>
    </div>
