...
const BanglaCoGiftCards = () => {
    ...
    const getText = (mapOrString) => {
        ...
        // mapOrString is likely an object like { en: '...', bn: '...' }
    ...
    return (
        <div className="bg-white min-h-screen font-sans pb-10">
            <div className="relative h-64 flex flex-col items-center justify-center text-white text-center p-4 overflow-hidden rounded-xl shadow-lg">
                ...
                {/* Black Overlay Layer - Only darkens the image, not the text */}
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-xl font-medium text-gray-100 opacity-90 drop-shadow-md">
                        A special way to greet the loved people
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl">
                {loading ? (
                    ...
                    cards.map((card, index) => (
                        <div key={card._id || index} className="flex rounded-xl overflow-hidden shadow-lg h-44 cursor-pointer hover:scale-[1.02] transition-transform">
                            ...
                            <div className={`w-3/5 ${card.color || 'bg-primary'} text-white p-6 relative flex flex-col justify-center`}>
                                ...
                                <div className="z-10">
                                    ...
                                    <p className="text-[11px] leading-relaxed font-medium">{getText(card.subtitle)}</p>
                                </div>
                            </div>
                        </div>
                    ))
